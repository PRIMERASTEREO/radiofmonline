...
"border-top-left-radius": 100 - 100 * Ea + "%",
"border-top-right-radius": 100 - 100 * Fa + "%",
"border-bottom-left-radius": 100 - 100 * Ea + "%",
"border-bottom-right-radius": 100 - 100 * Fa + "%"
});
try {
switch (ja) {
case 0:
...
for (var fb = r(t.token, ""), fa = r(t.userinterface, "small").toString().toLowerCase(), ub = r(t.backgroundcolor, "rgba(0,0,0,0)"), A = r(t.fontcolor, "#ffffff"), u = r(t.hightlightcolor, "#067dcc"), ka = r(t.fontname, ""), eb = r(t.googlefont, ""), qb = r(t.fontratio, "0.4"), ob = r(t.radioname, ""), Da = r(t.scroll, "true").toString().toLowerCase(), ra = r(t.coverimage,
